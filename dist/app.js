// Wave Planner vdev-2026-05-13 — built 2026-05-13T08:20:38.129Z
      ...
      if (wp) {
        ...
        if (plan?.json) {
          try {
            ...
            // Saved plan columns/thresholds restored, but enemy location
            // is ALWAYS taken from IntelState.enemyKd (set in bootstrap).
            // Only use saved location as absolute last resort if IS had nothing.
