// Wave Planner vdev-2026-05-15d — built 2026-05-15T00:00:00.000Z
// DO NOT EDIT — generated by build.js from src/
(function(){
'use strict';
console.log('[WavePlanner] vdev-2026-05-15d loaded');
...
<div id="__wph">
  ...
  <button class="wb" onclick="__wpA.clearPlan()" title="Clear all wave assignments and start fresh" style="border-color:#8B1414;color:#E05050;">🗑 Clear Plan</button>
...
window.__wpA = {
  ...
  tab(t) {
    S.tab = t;
    ['board', 'player', 'intel', 'summary', 'nwgraph', 'alerts', 'leaderboard'].forEach(x => {
...
console.log(`[WavePlanner] bootstrap: enemyKd="${_IS.enemyKd}" → ENEMY_KD="${ENEMY_KD}" atWar=${!!_IS.kingdomNews?.startDate} endDate=${JSON.stringify(_IS.kingdomNews?.endDate)}`);
