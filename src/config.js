...
.writ-drop{position:absolute;top:calc(100% + 6px);left:0;z-index:99999;background:#0f1218;border:1px solid #2a3f55;border-radius:4px;padding:12px 14px;min-width:220px;box-shadow:0 8px 24px rgba(0,0,0,.8)}
